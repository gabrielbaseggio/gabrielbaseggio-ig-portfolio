export const profile = {
  ...
  bio: "Full Stack Developer · CS @ UNRC · 9.63 GPA",
  location: "Córdoba, Argentina",
  email: "baseggioaxel@gmail.com",
  github: "https://github.com/gabrielbaseggio",
  stats: {
    projects: 3,
    technologies: "15+",
    yearsExp: 4,
...
export const posts: Post[] = [
  ...
  // Skills — 5 items, collapses after 3
  {
    id: "skill-ts",
    type: "skills",
    title: "TypeScript",
    subtitle: "Primary Lang",
    detail: "JavaScript · Node",
    href: "/skills",
  },
  {
    id: "skill-rails",
...
export const works: WorkItem[] = [
  ...
  },
  {
    ...
    tech: ["Ruby on Rails", "Stimulus", "Turbo Frames", "Tailwind CSS", "PostgreSQL", "RSpec"],
    bullets: [
  ...
  },
  {
    ...
    tech: ["Ruby on Rails", "Stimulus", "Tailwind CSS", "PostgreSQL", "RSpec"],
    bullets: [
...
// Exact skills from resume (resume_en.tex)
export const skills: Skills = {
  languages: ["TypeScript", "JavaScript", "Python", "Ruby", "Java", "C/C++", "Haskell"],
  frontend: ["React", "Next.js", "React Native", "Stimulus", "Turbo Frames", "HTML", "CSS"],
  backend: ["Ruby on Rails", "Node.js", "Sidekiq", "PostgreSQL", "Redis", "SQL"],
...
export const skillCards: SkillCard[] = [
  ...
  { id: "javascript",    name: "JavaScript",    displayName: "JS",     category: "languages" },
  ...
  { id: "nextjs",        name: "Next.js",        displayName: "Next",  category: "frontend" },
  { id: "react-native",  name: "React Native",  displayName: "Native", category: "frontend" },
  { id: "stimulus",      name: "Stimulus",       category: "frontend" },
  { id: "turboframes",   name: "Turbo Frames",  displayName: "Turbo",  category: "frontend" },
  { id: "html",          name: "HTML",           category: "frontend" },
  { id: "css",           name: "CSS",            category: "frontend" },
  // Backend & Databases
  { id: "rails",         name: "Ruby on Rails", displayName: "Rails",  category: "backend" },
  { id: "nodejs",        name: "Node.js",        displayName: "Node",  category: "backend" },
  { id: "sidekiq",       name: "Sidekiq",        category: "backend" },
  { id: "postgresql",    name: "PostgreSQL",     displayName: "Postgres", category: "backend" },
  ...
  { id: "gcp",           name: "GCP",            category: "tools" },
]
